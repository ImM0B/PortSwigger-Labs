...
Esto es útil en una página de blog, por ejemplo, para desplazar automáticamente a una entrada específica cuando se usa un enlace con un hash que corresponde a un título de entrada en la página.